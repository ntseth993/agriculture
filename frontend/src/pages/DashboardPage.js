      ...
      <nav className="bg-white dark:bg-gray-800 shadow-md">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Crop Health Advisory</h1>
          </div>
      ...
      <div className="max-w-6xl mx-auto p-4 py-8">
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="bg-gradient-to-br from-green-400 to-green-600 rounded-lg shadow-lg p-6 text-white hover:shadow-xl transition-shadow">
            ...
            <a href="/detect" className="text-white underline mt-2 block hover:no-underline font-semibold">
              Start Detection →
            </a>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-400 to-blue-600 rounded-lg shadow-lg p-6 text-white hover:shadow-xl transition-shadow">
            ...
            <a href="/locations" className="text-white underline mt-2 block hover:no-underline font-semibold">
              View Map →
            </a>
          </div>

          <div className="bg-gradient-to-br from-yellow-400 to-orange-600 rounded-lg shadow-lg p-6 text-white hover:shadow-xl transition-shadow">
            <h3 className="text-lg font-semibold mb-2">My Alerts</h3>
            <p className="text-sm">Receive weather and pest alerts</p>
            <a href="/alerts" className="text-white underline mt-2 block hover:no-underline font-semibold">
              View Alerts →
            </a>
          </div>
        </div>
